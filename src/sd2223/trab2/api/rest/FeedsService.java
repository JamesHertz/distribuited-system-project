...
public interface FeedsService {
	...
	long postMessage(@Context ContainerRequest request, @PathParam(USER) String user, @QueryParam(PWD) String pwd, Message msg);
	...
	@DELETE
	@Path("/{" + USER + "}/{" + MID + "}")
	void removeFromPersonalFeed(@Context ContainerRequest request, @PathParam(USER) String user, @PathParam(MID) long mid, @QueryParam(PWD) String pwd);
	...
	void subUser(@Context ContainerRequest request, @PathParam(USER) String user, @PathParam(USERSUB) String userSub, @QueryParam(PWD) String pwd);
	...
	@DELETE
	@Path("/sub/{" + USER + "}/{" + USERSUB + "}")
	void unsubscribeUser(@Context ContainerRequest request, @PathParam(USER) String user, @PathParam(USERSUB) String userSub, @QueryParam(PWD) String pwd);
	 ...
	 */
	@POST
	@Consumes(MediaType.APPLICATION_JSON) // @Context ContainerRequest request
	void createFeed(@Context ContainerRequest request, String user , @QueryParam(SECRET) String secret);
	...
	@DELETE
	@Path("/{" + USER + "}")
	void removeFeed(@Context ContainerRequest request, @PathParam(USER) String user, @QueryParam(SECRET) String secret);
	...
	@Produces(MediaType.APPLICATION_JSON)
	List<Message> subscribeServer(@Context ContainerRequest request, @PathParam(DOMAIN) String domain, @PathParam(USER) String user, @QueryParam(SECRET) String secret);
	...
	@DELETE
	@Path("/" + SERVERSUB + "/{" + DOMAIN + "}/{" + USER + "}")
	void unsubscribeServer(@Context ContainerRequest request, @PathParam(DOMAIN) String domain, @PathParam(USER) String user, @QueryParam(SECRET) String secret);
	...
	@Path(EXTERNAL + "/{" + USER +"}")
	@Consumes(MediaType.APPLICATION_JSON)
	void createExtFeedMessage(@Context ContainerRequest request, @PathParam(USER) String user, @QueryParam(SECRET) String secret, Message msg);
	...
	void removeExtFeedMessage(@Context ContainerRequest request, @PathParam(USER) String user, @PathParam(MID) long mid, @QueryParam(SECRET) String secret);
	...
	@DELETE
	@Path(EXTERNAL + "/{" + USER + "}")
	void removeExtFeed(@Context ContainerRequest request, @PathParam(USER) String user, @QueryParam(SECRET) String secret);
